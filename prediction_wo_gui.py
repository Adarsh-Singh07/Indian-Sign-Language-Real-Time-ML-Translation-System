...
# ── Paths resolved relative to this script so it works on any machine ──
...
# Pre-load white canvas ONCE; use .copy() inside the loop
WHITE_TEMPLATE = cv2.imread(WHITE_PATH)
...
while True:
    try:
        ...
        if hand_list:
            ...
            # Fresh copy of pre-loaded white canvas (no disk read in loop)
            ...
            if hand_list2:
                ...
                # ── BUG FIX: `or 'E'` is always truthy — use `in [...]` instead ──
